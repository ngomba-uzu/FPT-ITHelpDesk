...
namespace ITHelpDesk.Controllers
{
    public class PrioritiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PriorityName")] Priority priority)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PriorityName")] Priority priority)
        {
            if (id != priority.Id)
            {
                return NotFound();
