...
namespace ITHelpDesk.Data.Migrations
{
    ...
    [Migration("20250612105834_updateTechinicianGroupToManyToMany")]
    partial class updateTechinicianGroupToManyToMany
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ITHelpDesk.Models.Ticket", b =>
                {
                    ...
                    b.Property<string>("EmailToNotify")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int?>("ManuallyAssignedToId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SubcategoryTechnicianGroup", b =>
                {
                    b.Property<int>("SubcategoriesId")
                        .HasColumnType("int");

                    b.Property<int>("TechnicianGroupsId")
                        .HasColumnType("int");

                    b.HasKey("SubcategoriesId", "TechnicianGroupsId");

                    b.HasIndex("TechnicianGroupsId");

                    b.ToTable("SubcategoryTechnicianGroup");
                });

            modelBuilder.Entity("TechnicianGroupTicket", b =>
                {
                    b.Property<int>("TechnicianGroupsId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("TechnicianGroupsId", "TicketsId");

                    b.HasIndex("TicketsId");

                    b.ToTable("TechnicianGroupTicket");
                });
            ...
            modelBuilder.Entity("ITHelpDesk.Models.Ticket", b =>
                {
                    ...
                    b.Navigation("ManuallyAssignedTo");
            ...
            modelBuilder.Entity("SubcategoryTechnicianGroup", b =>
                {
                    b.HasOne("ITHelpDesk.Models.Subcategory", null)
                        .WithMany()
                        .HasForeignKey("SubcategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ITHelpDesk.Models.TechnicianGroup", null)
                        .WithMany()
                        .HasForeignKey("TechnicianGroupsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
