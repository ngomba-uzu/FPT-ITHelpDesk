...
namespace ITHelpDesk.Data.Migrations
{
    ...
    [Migration("20250414072211_MyTicketsandTechnicians")]
    partial class MyTicketsandTechnicians
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ITHelpDesk.Models.Status", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            EscalationThresholdInMinutes = 5,
                            StatusName = "Unassigned"
                        },
                        new
                        {
                            Id = 2,
                            EscalationThresholdInMinutes = 0,
                            StatusName = "Assigned"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("ITHelpDesk.Models.SubcategoryTechnician", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SubcategoryTechnicians");
                });
            ...
            modelBuilder.Entity("ITHelpDesk.Models.SubcategoryTechnician", b =>
                {
                    ...
                    b.HasOne("ITHelpDesk.Models.Technician", "Technician")
                        .WithMany("SubcategoryTechnicians")
            ...
            modelBuilder.Entity("ITHelpDesk.Models.Technician", b =>
                {
                    b.Navigation("SubcategoryTechnicians");
                });
